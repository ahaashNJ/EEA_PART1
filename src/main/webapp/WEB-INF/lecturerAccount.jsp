...
<section>
    <div class = "container">
        <div class = "formInfo">
            <div>
                <h2>${lecturerUpdate.firstName} ${lecturerUpdate.lastName}</h2>
                <ul class = "lines">
        ...
        <div class = "requestForm">
            <form:form action="/LecturerUpdateUser" method="POST" modelAttribute="lecturerUpdate">

                <h3>My Account</h3>

                <div class = "formBox">
                    <form:input path="firstName" value="${lecturerUpdate.firstName}" type = "hidden" readonly="true" />
                    <form:input path="lastName" value="${lecturerUpdate.lastName}" type = "hidden" readonly="true"/>
                    <div class = "inputBox w50">
                        <form:input path="email" value="${lecturerUpdate.email}" type = "text" readonly="true"/>
                        <span>Email</span>
                    </div>

                    <div class = "inputBox w50">
                        <form:input path="contactNumber" value="${lecturerUpdate.contactNumber}" type = "text" minlength="10" maxlength="10" pattern="[0-9]+" title="Please be advised to only include numbers"/>
