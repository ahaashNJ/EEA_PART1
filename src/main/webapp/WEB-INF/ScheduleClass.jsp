...
<section>
    <div class = "container">
        <div class = "formInfo">
            <div>
                <div class="smallBox">${ModuleDetails.moduleName}</div>
        ...
        <div class = "requestForm">
            ...
            <form:form action="${pageContext.request.contextPath}/AdminScheduleClass" method="POST" modelAttribute="AddTimetables">

                <div class = "formBox">
                    <form:input path="module" value="${ModuleDetails.moduleID}" type = "hidden"/>
                    ...
                    <div class="selectBox w50">
                        <label>Batch/Batches</label>
                            <form:select path="batchList" type="text" style="border-color: black" cssClass="form-control"
                                         required="true">
                                <c:forEach var="listBatch" items="${ModuleDetails.batchList}" varStatus="item">
